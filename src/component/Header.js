            ...
            {({open}) => (
                ...
                <div className="mx-0 w-full  bg-white-700 mt-2 px-2 sm:px-6 lg:px-8">
                    <div className="relative flex h-16 items-center justify-between">
                        ...
                        <div className="flex w-full mr-20 items-center justify-start sm:items-stretch sm:justify-start">
                            ...
                            <form class="flex items-center max-w-lg mx-auto">   
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" id="voice-search" class="bg-white-50 border border-gray-300 text-black-900 text-sm rounded-lg outline-none focus:ring-clack-500 focus:border-gray-500 block w-full ps-10 p-2.5 shadow-lg dark:bg-black-700 dark:border-gray-600 dark:placeholder-black-400 dark:text-black dark:focus:ring-black-500 dark:focus:border-black-500" placeholder="Search Tech, Media....." required />
                                </div>
                                <button type="submit" class="inline-flex items-center py-2.5 px-2 ms-2 text-sm font-medium text-black bg-white rounded-lg border border-black-700 shadow-md shadow-inner shadow-gray-500 hover:bg--800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg--600 dark:hover:bg--700 dark:focus:ring--800">
                                ...
                                <div className="flex space-x-10">
                                    ...
                                    <a
                                        ...
                                        className={classNames(
                                            item.current ? 'bg-gray-900 text-white' : 'text-black-700 opacity-50 hover:ease-out',
